...
int convertStringToAction(string str_action)
{
    ...
    if(str_action == "EXIT_NO_CONTINUE")
        return KeyConfig::ACTION_EXIT_NO_CONTINUE;
    if(str_action == "EXIT")
...
map<int, int> KeyConfig::buildDefaultKeymap()
{
    ...
    keymap['r'] = ACTION_TOGGLE_SUBTITLE;
    keymap['d'] = ACTION_DECREASE_SUBTITLE_DELAY;
    keymap['f'] = ACTION_INCREASE_SUBTITLE_DELAY;
    keymap['q'] = ACTION_EXIT;
    keymap['l'] = ACTION_EXIT_NO_CONTINUE;
    keymap[KEY_ESC] = ACTION_EXIT;
    keymap['p'] = ACTION_PAUSE;
    keymap[' '] = ACTION_PAUSE;
    keymap['s'] = ACTION_DECREASE_VOLUME;
    keymap['a'] = ACTION_INCREASE_VOLUME;
    keymap['='] = ACTION_INCREASE_VOLUME;
    keymap['b'] = ACTION_SEEK_BACK_SMALL;
    keymap['f'] = ACTION_SEEK_FORWARD_SMALL;
